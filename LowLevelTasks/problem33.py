"""
Необходимо объявить класс-декоратор с именем HandlerGET, который будет имитировать обработку GET-запросов на стороне сервера.
...
class HandlerGET:
    ...
    def __call__(self, *args, **kwargs):
        for i in args:
            if i.get('method') == 'GET' or 'method' not in i.keys():
                return f"GET: {self.__f(args)}"
        return
