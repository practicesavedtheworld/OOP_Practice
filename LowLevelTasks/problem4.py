...
означающая наличие мины в текущей клетке. При этом, в каждом объекте класса Cell
должны создаваться локальные свойства:
...
Вызовите метод init() для расстановки мин по игровому полю и подсчета числа мин вокруг клеток без мин.
'''