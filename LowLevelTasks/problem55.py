...
строку по словам (слова разделяются одним или несколькими пробелами).
...
if __name__ == '__main__':
    asf = "–?!,.;"
    lst_text = [StringText(x.strip(asf) for x in line.split() if len(x.strip(asf)) > 0) for line in stich]
