...
Необходимо в классе Point реализовать метод clone(self), который бы создавал новый объект
класса Point как полную копию текущего объекта (с тем же набором и значениями всех локальных свойств).
